# Extracts an icon from a system DLL -> multi-size BMP-encoded .ico (16/32/48/256 px).
# Usage: extract_icon.ps1 -OutPath <path> -DllName <dll> -Index <n>
param(
    [string]$OutPath,
    [string]$DllName = "shell32.dll",
    [int]   $Index   = 0
)
...
$dllPath = Join-Path $sysDir $DllName
