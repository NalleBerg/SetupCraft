...
**Current Release:** Version 2026.03.11.08 (Published: 11.03.2026 08:31)
...
- **Required-Folder Icon**: Folders in the Components tree where every file (recursively) carries the Required flag are shown with a blue-checkmark badge icon (`imageres.dll` #110). The icon is assigned by `UpdateCompTreeRequiredIcons()` after each tree build or Edit Folder operation and reverts automatically when any file inside loses the Required flag
